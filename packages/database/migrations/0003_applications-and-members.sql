...
--> statement-breakpoint
ALTER TABLE "applications" ADD CONSTRAINT "applications_game_id_games_id_fk" FOREIGN KEY ("game_id") REFERENCES "public"."games"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "applications_game_id_index" ON "applications" USING btree ("game_id");--> statement-breakpoint
...
CREATE INDEX "game_members_user_id_index" ON "game_members" USING btree ("user_id");--> statement-breakpoint
