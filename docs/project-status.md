...
| F07 | Présences, absences et notifications applicatives | `IN_PROGRESS` | `feat/attendance-notifications` | Création bloquée par GitHub (`403`) ; [ouverture manuelle](https://github.com/thomasO82/jdr_hub/pull/new/feat/attendance-notifications) | 98 fichiers, 248 tests monorepo verts + 3 intégration PostgreSQL ; lint, typecheck, builds API/web et Compose healthy | Session/origine/rate limit, autorisation par membre/MJ, transaction idempotente, notifications internes ; historique Discord conservé sans nouvelle livraison | [Fiche F07](features/013-attendance-notifications.md) |
| F07B | Messagerie textuelle par partie | `IN_PROGRESS` | `feat/game-messaging` | Non créée | Tests unitaires, API, intégration PostgreSQL/Redis et composants ; vérifications globales à consigner avant PR | Autorisation propriétaire/membre actif, lecture seule des parties fermées, contenu borné/échappé, rate limit, SSE revalidé, Redis interne | [Fiche F07B](features/015-game-messaging.md) |
