...
| F04 | Candidatures et roster | `IN_PROGRESS` | `feat/applications` | Non créée | 134 tests monorepo verts ; lint, typecheck et build verts | Autorisation par ressource, anti-doublon, transaction de capacité, origine et validation stricte | [Fiche F04](features/007-applications.md) |
