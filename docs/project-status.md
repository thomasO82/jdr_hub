...
| F05 | Disponibilités et recherche de joueurs | `IN_PROGRESS` | `feat/availability-and-player-search` | Non créée | Conception validée à documenter ; tests à écrire | CSRF, horaires privés, projection agrégée, pagination et validation stricte | [Fiche F05](features/011-availability-and-player-search.md) |
