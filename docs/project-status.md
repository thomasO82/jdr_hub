...
| F04 | Candidatures et roster | `IN_REVIEW` | `feat/applications` | À créer | 135 tests monorepo verts ; lint, typecheck, build et Docker web verts | Autorisation par ressource, anti-doublon, transaction de capacité, origine et validation stricte | [Fiche F04](features/007-applications.md) |
