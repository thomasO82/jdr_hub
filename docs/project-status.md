...
| F02 | Parties, tags et cycle de vie | `IN_PROGRESS` | `feat/games-and-tags` | Non créée | 91 tests monorepo verts ; implémentation en cours | Contrôles d’autorisation, validation stricte et invariants métier | [Fiche F02](features/004-games-and-tags.md) |
