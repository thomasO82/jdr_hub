...
| F00 | Socle monorepo, Docker et CI sécurisée | `IN_PROGRESS` | `chore/monorepo-foundation` | Non créée — cible `develop` | API : 7 tests ; web : 1 smoke test ; architecture : 5 tests ; typechecks/builds passants | Contrôles techniques à effectuer avant la PR | [Fiche F00](features/001-monorepo-foundation.md) |
