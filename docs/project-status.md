...
| F17 | Filtres avancés du catalogue public | `IN_PROGRESS` | `feat/advanced-catalog-filters` | Non créée | 125 fichiers, 339 tests normaux + 12 tests PostgreSQL ; lint, typecheck et build verts | Contrat Zod strict, projection publique, requêtes paramétrées, visibilité publique et calcul borné des places | [Fiche F17](features/017-advanced-catalog-filters.md) |
