...
import { AbsenceDialog } from '../attendance/absence-dialog'

function monthLabel(month: Date): string {
  return new Intl.DateTimeFormat('fr-FR', { month: 'long', year: 'numeric' }).format(month)
}

export function PlanningView({ initial }: { initial: PlanningPage }) {
  const [month, setMonth] = useState(() => new Date())
  const [absenceSession, setAbsenceSession] = useState<PlanningPage['items'][number] | null>(null)
