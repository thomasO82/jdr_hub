        ...
        <form className="mx-auto grid max-w-6xl items-start gap-6 lg:grid-cols-3" action="/parties" method="get">
          <aside className="rounded-xl border border-surface-container-highest bg-surface p-4 shadow-sm lg:col-span-1" aria-label="Filtres des parties">
            ...
            <FiltersToggle>
              ...
              <div className="grid gap-2"><span className="font-label text-xs font-bold uppercase tracking-wider text-on-surface-variant">Date d’une séance</span><div className="grid grid-cols-1 gap-2 2xl:grid-cols-2"><label className="grid gap-1 font-body text-xs text-on-surface-variant">Du<input className="min-h-10 rounded-lg border border-outline-variant bg-surface px-2 font-body text-sm text-on-surface outline-none focus:border-primary focus:outline-2 focus:outline-primary/30" name="dateFrom" type="date" defaultValue={selectedValue(searchParams, 'dateFrom')} /></label><label className="grid gap-1 font-body text-xs text-on-surface-variant">Au<input className="min-h-10 rounded-lg border border-outline-variant bg-surface px-2 font-body text-sm text-on-surface outline-none focus:border-primary focus:outline-2 focus:outline-primary/30" name="dateTo" type="date" defaultValue={selectedValue(searchParams, 'dateTo')} /></label></div></div>
